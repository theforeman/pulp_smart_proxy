...
from pulp_smart_proxy.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_smart_proxy import RemotesSmrtApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesSmrtApi(gen_smrt_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesSmrtApi(gen_smrt_client()).create(body)
