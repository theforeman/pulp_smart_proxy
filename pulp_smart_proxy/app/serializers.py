...
class SmrtContentSerializer(platform.SingleArtifactContentSerializer):
    """
    A Serializer for SmrtContent.

    Add serializers for the new fields defined in SmrtContent and
...
class SmrtRemoteSerializer(platform.RemoteSerializer):
    """
    A Serializer for SmrtRemote.

    Add any new fields if defined on SmrtRemote.
    Similar to the example above, in SmrtContentSerializer.
...
class SmrtRepositorySerializer(platform.RepositorySerializer):
    """
    A Serializer for SmrtRepository.

    Add any new fields if defined on SmrtRepository.
    Similar to the example above, in SmrtContentSerializer.
    Additional validators can be added to the parent validators list
    ...
    class Meta:
        ...
        model = models.SmrtRepository


class SmrtPublicationSerializer(platform.PublicationSerializer):
    """
    A Serializer for SmrtPublication.

    Add any new fields if defined on SmrtPublication.
    Similar to the example above, in SmrtContentSerializer.
    Additional validators can be added to the parent validators list
    ...
    class Meta:
        ...
        model = models.SmrtPublication


class SmrtDistributionSerializer(platform.DistributionSerializer):
    """
    A Serializer for SmrtDistribution.

    Add any new fields if defined on SmrtDistribution.
    Similar to the example above, in SmrtContentSerializer.
    Additional validators can be added to the parent validators list
