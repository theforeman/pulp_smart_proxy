...
---
scenario: "${TEST}"
plugin_name: "pulp_smart_proxy"
legacy_component_name: "pulp_smart_proxy"
component_name: "smart_proxy"
...
image:
  ...
  webserver_snippet: $(test -f pulp_smart_proxy/app/webserver_snippets/nginx.conf && echo -n true || echo -n false )
extra_files:
  - origin: "pulp_smart_proxy"
    destination: "pulp_smart_proxy"
services:
  - name: "pulp"
    image: "pulp:ci_build"
    volumes:
