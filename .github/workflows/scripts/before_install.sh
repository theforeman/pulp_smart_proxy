...
echo "legacy_component_name: pulp_smart_proxy" >> .ci/ansible/vars/main.yaml
echo "component_name: smart_proxy" >> .ci/ansible/vars/main.yaml
...
if [ "$GITHUB_EVENT_NAME" = "pull_request" ] || [ "${BRANCH_BUILD}" = "1" -a "${BRANCH}" != "develop" ]
then
